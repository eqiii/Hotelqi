    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 mb-6">
                ...
                <div class="mt-4">
                    <h1 class="font-playfair text-2xl font-bold text-[#2E2E2E]">Edit Room Type</h1>
                    <p class="text-gray-500 text-sm mt-1">Perbarui informasi tipe kamar.</p>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="base_price" value="{{ old('base_price', $roomType->base_price) }}" required step="0.01" min="0"
                        ...
                        <div>
                            ...
                            <input type="number" name="max_guest" value="{{ old('max_guest', $roomType->max_guest) }}" min="1"
                        ...
                        <div>
                            ...
                            <input type="number" name="total_bed" value="{{ old('total_bed', $roomType->total_bed) }}" min="1"
                        ...
                        <div>
                            ...
                            @if ($roomType->image)
                                <div class="mt-3">
                                    <img src="{{ asset('storage/' . $roomType->image) }}" alt="{{ $roomType->name }}" class="h-32 rounded-xl object-cover shadow-sm border border-gray-200">
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" rows="4"
                                      ...
                                      placeholder="Deskripsi lengkap tentang tipe kamar...">{{ old('description', $roomType->description) }}</textarea>
